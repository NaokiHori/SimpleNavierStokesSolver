...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print("Give directory name to be visualised and resulting file name")
        print("  e.g., python3 visualise.py ../output/save/step0000004000 visualise.png")
    ...
    ax111.contourf(y, x, temp.T, vmin=-0.5, vmax=+0.5, cmap="jet", levels=11)
    kwrds = {
