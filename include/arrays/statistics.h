...
/* temp1 (double, 2D) [0:itot+1] x [0:jsize+1] */
#define TEMP1_MIN_I (0)
#define TEMP1_MAX_I (itot+1)
#define TEMP1_LEN_I (TEMP1_MAX_I-TEMP1_MIN_I+1)
#define TEMP1_MIN_J (0)
#define TEMP1_MAX_J (jsize+1)
#define TEMP1_LEN_J (TEMP1_MAX_J-TEMP1_MIN_J+1)
#define TEMP1_MEMSIZE (sizeof(double)*(TEMP1_LEN_I)*(TEMP1_LEN_J))
#define TEMP1(I, J) (temp1[(J)*(itot+2)+(I)])

/* temp2 (double, 2D) [0:itot+1] x [0:jsize+1] */
#define TEMP2_MIN_I (0)
#define TEMP2_MAX_I (itot+1)
#define TEMP2_LEN_I (TEMP2_MAX_I-TEMP2_MIN_I+1)
#define TEMP2_MIN_J (0)
#define TEMP2_MAX_J (jsize+1)
#define TEMP2_LEN_J (TEMP2_MAX_J-TEMP2_MIN_J+1)
#define TEMP2_MEMSIZE (sizeof(double)*(TEMP2_LEN_I)*(TEMP2_LEN_J))
#define TEMP2(I, J) (temp2[(J)*(itot+2)+(I)])
