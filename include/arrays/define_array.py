...
if __name__ == "__main__":
    ...
    with open("param.h", "w", encoding="utf-8") as f:
        ...
        generate_grid_1d(f, "yf",  "double", "J", 1, "jtot+1")
        generate_grid_1d(f, "yc",  "double", "J", 1, "jtot  ")
    ...
    with open("temperature.h", "w", encoding="utf-8") as f:
        attach_header(f, "temperature")
        generate_grid_2d(f, "temp",       "double", 0, "itot+2",  0, "jsize+2")
        generate_grid_2d(f, "tempforcex", "double", 2, "itot-1",  1, "jsize  ")
        generate_grid_2d(f, "srctempa",   "double", 1, "itot  ",  1, "jsize  ")
        generate_grid_2d(f, "srctempb",   "double", 1, "itot  ",  1, "jsize  ")
        generate_grid_2d(f, "srctempg",   "double", 1, "itot  ",  1, "jsize  ")
    ...
    with open("statistics.h", "w", encoding="utf-8") as f:
        ...
        generate_grid_2d(f, "temp1", "double", 0, "itot+2",  0, "jsize+2")
        generate_grid_2d(f, "temp2", "double", 0, "itot+2",  0, "jsize+2")
